...
def run_sim_pm(filename, n_particles, n_grid, n_frames, show_ps=True, ps_bins=50):
    return
...
if __name__ == '__main__':
    ...
    if plot_powerspectrum:
        ...
        bin_width = bin_edges[1] - bin_edges[0]
        bin_mids = (bin_edges + bin_width)[:-1]
        corrfunc = ax3.bar(bin_mids, np.zeros(len(bin_mids)), align='center', width=(n_grid_cells * np.sqrt(3))/n_bins, color='white', edgecolor='royalblue')
